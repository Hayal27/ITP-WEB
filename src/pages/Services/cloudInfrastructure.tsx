...
const CloudInfrastructure: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-white min-h-screen w-full pt-36 md:pt-20">
      {/* Hero Section */}
      <section className="relative text-white py-16 px-4 md:px-12 lg:px-24 3xl:px-48 4xl:px-64 5xl:px-96 3xl:py-24 4xl:py-32 5xl:py-40 flex flex-col items-center text-center" style={{ background: 'linear-gradient(135deg, #0C7C92 0%, #16284F 100%)' }}>
      ...
      <section className="max-w-6xl 3xl:max-w-7xl 4xl:max-w-8xl 5xl:max-w-screen-2xl mx-auto py-16 3xl:py-24 4xl:py-32 5xl:py-40 px-4 md:px-8 3xl:px-20 4xl:px-32 5xl:px-48">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl 3xl:text-5xl 4xl:text-6xl 5xl:text-7xl font-bold mb-4" style={{ color: '#16284F' }}>Why Choose Ethiopian IT Park Cloud?</h2>
          <p className="text-lg md:text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 3xl:gap-12 4xl:gap-16 5xl:gap-20">
          <div className="bg-white rounded-xl shadow-lg p-8 3xl:p-12 4xl:p-16 5xl:p-20 border-t-4 hover:shadow-xl transition-shadow" style={{ borderTopColor: '#0C7C92' }}>
            <div className="w-16 h-16 3xl:w-20 3xl:h-20 4xl:w-24 4xl:h-24 5xl:w-32 5xl:h-32 rounded-full flex items-center justify-center mb-6 mx-auto" style={{ background: 'linear-gradient(135deg, #0C7C92, #6EC9C4)' }}>
              <i className="fas fa-map-marker-alt text-white text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl"></i>
            </div>
            <h3 className="text-xl md:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl font-bold mb-4 text-center" style={{ color: '#16284F' }}>Local Infrastructure</h3>
            <p className="text-gray-600 text-center 3xl:text-lg 4xl:text-xl 5xl:text-2xl">
              Ethiopian-based data center ensuring low latency and data residency compliance
            </p>
          </div>

          <div className="bg-white rounded-xl shadow-lg p-8 3xl:p-12 4xl:p-16 5xl:p-20 border-t-4 hover:shadow-xl transition-shadow" style={{ borderTopColor: '#6EC9C4' }}>
            <div className="w-16 h-16 3xl:w-20 3xl:h-20 4xl:w-24 4xl:h-24 5xl:w-32 5xl:h-32 rounded-full flex items-center justify-center mb-6 mx-auto" style={{ background: 'linear-gradient(135deg, #6EC9C4, #0C7C92)' }}>
              <i className="fas fa-money-bill-wave text-white text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl"></i>
            </div>
            <h3 className="text-xl md:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl font-bold mb-4 text-center" style={{ color: '#16284F' }}>Affordable Pricing</h3>
            <p className="text-gray-600 text-center 3xl:text-lg 4xl:text-xl 5xl:text-2xl">
              Competitive rates designed for startups and growing Ethiopian businesses
            </p>
          </div>

          <div className="bg-white rounded-xl shadow-lg p-8 3xl:p-12 4xl:p-16 5xl:p-20 border-t-4 hover:shadow-xl transition-shadow" style={{ borderTopColor: '#16284F' }}>
            <div className="w-16 h-16 3xl:w-20 3xl:h-20 4xl:w-24 4xl:h-24 5xl:w-32 5xl:h-32 rounded-full flex items-center justify-center mb-6 mx-auto" style={{ background: 'linear-gradient(135deg, #16284F, #0C7C92)' }}>
              <i className="fas fa-headset text-white text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl"></i>
            </div>
            <h3 className="text-xl md:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl font-bold mb-4 text-center" style={{ color: '#16284F' }}>Local Support</h3>
            <p className="text-gray-600 text-center 3xl:text-lg 4xl:text-xl 5xl:text-2xl">
      ...
      {/* Feature Accordion */}
      <section className="max-w-5xl 3xl:max-w-7xl 4xl:max-w-8xl 5xl:max-w-screen-2xl mx-auto py-12 3xl:py-20 4xl:py-28 5xl:py-36 px-4 md:px-8 3xl:px-20 4xl:px-32 5xl:px-48 bg-white">
        <h2 className="text-2xl md:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl font-bold mb-8 text-center" style={{ color: '#16284F' }}>Services & Features</h2>
        <div className="space-y-4 3xl:space-y-8">
          {features.map((f, idx) => (
            <div key={f.title} className="border rounded-lg bg-white shadow-sm overflow-hidden 3xl:text-xl 4xl:text-2xl 5xl:text-3xl" style={{ borderColor: '#6EC9C4' }}>
              <button
                className="w-full flex items-center bg-white justify-between px-6 py-4 3xl:px-12 3xl:py-8 4xl:px-16 4xl:py-10 5xl:px-24 5xl:py-14 text-left focus:outline-none focus:ring-2 transition-colors hover:bg-slate-50"
                style={{ color: '#0C7C92' }}
                onClick={() => setOpenIdx(openIdx === idx ? null : idx)}
                aria-expanded={openIdx === idx}
              >
                <div className="flex items-center gap-3 3xl:gap-6">
                  <i className={`fas ${f.icon} text-xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl`} style={{ color: '#0C7C92' }}></i>
                  <span className="font-semibold text-lg md:text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl" style={{ color: '#16284F' }}>{f.title}</span>
                </div>
                <i className={`fas fa-chevron-${openIdx === idx ? 'up' : 'down'} text-lg 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl transition-transform`} style={{ color: '#6EC9C4' }}></i>
              </button>
              {openIdx === idx && (
                <div className="px-8 pb-6 pt-2 3xl:px-16 3xl:pb-12 4xl:px-24 4xl:pb-16 5xl:px-32 5xl:pb-20 text-gray-700 animate-fade-in" style={{ borderTop: '2px solid #6EC9C4' }}>
                  {f.content}
                </div>
              )}
            </div>
      ...
      <section className="py-16 3xl:py-24 4xl:py-32 5xl:py-40 px-4 md:px-8 3xl:px-20 4xl:px-32 5xl:px-48" style={{ background: 'linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%)' }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl 3xl:text-5xl 4xl:text-6xl 5xl:text-7xl font-bold mb-4" style={{ color: '#16284F' }}>
              Collaborate with Zergaw Cloud
            </h2>
            <div className="w-24 h-1 mx-auto mb-8" style={{ background: 'linear-gradient(90deg, #0C7C92, #6EC9C4)' }}></div>
            <p className="text-lg md:text-xl 3xl:text-2xl 4xl:text-3xl 5xl:text-4xl text-gray-600 max-w-3xl mx-auto mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="mb-8">
                  <a href="https://zergaw.com/" target="_blank" rel="noopener noreferrer" className="inline-block transition-transform hover:scale-105">
                    <div className="bg-white p-6 rounded-xl shadow-md">
                      <h3 className="text-4xl 3xl:text-5xl 4xl:text-6xl 5xl:text-7xl font-bold" style={{ color: '#0C7C92' }}>ZERGAW</h3>
                      <p className="text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl" style={{ color: '#6EC9C4' }}>CLOUD</p>
                    </div>
                  </a>
                </div>
                <p className="text-gray-700 text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl leading-relaxed mb-6">
                  <strong style={{ color: '#16284F' }}>Zergaw Cloud</strong> is a leading cloud services provider in Ethiopia, established in 2019 by experienced ICT experts.
                </p>
                <p className="text-gray-600 3xl:text-lg 4xl:text-xl 5xl:text-2xl">
              ...
              <div className="p-12 3xl:p-16 4xl:p-20 5xl:p-24 bg-white">
                <h4 className="text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl font-bold mb-8" style={{ color: '#16284F' }}>Partnership Highlights</h4>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 3xl:w-14 3xl:h-14 4xl:w-16 4xl:h-16 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #0C7C92, #6EC9C4)' }}>
                      <i className="fas fa-server text-white text-xl 3xl:text-2xl 4xl:text-3xl"></i>
                    </div>
                    <div>
                      <h5 className="font-semibold text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl mb-2" style={{ color: '#16284F' }}>Local Infrastructure</h5>
                      <p className="text-gray-600 3xl:text-lg 4xl:text-xl 5xl:text-2xl">Data center hosted at Ethiopian IT Park premises in Addis Ababa</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 3xl:w-14 3xl:h-14 4xl:w-16 4xl:h-16 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #6EC9C4, #0C7C92)' }}>
                      <i className="fas fa-shield-alt text-white text-xl 3xl:text-2xl 4xl:text-3xl"></i>
                    </div>
                    <div>
                      <h5 className="font-semibold text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl mb-2" style={{ color: '#16284F' }}>Enterprise Security</h5>
                      <p className="text-gray-600 3xl:text-lg 4xl:text-xl 5xl:text-2xl">Compliance with Ethiopian data protection laws and global standards</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 3xl:w-14 3xl:h-14 4xl:w-16 4xl:h-16 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #16284F, #0C7C92)' }}>
                      <i className="fas fa-users text-white text-xl 3xl:text-2xl 4xl:text-3xl"></i>
                    </div>
                    <div>
                      <h5 className="font-semibold text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl mb-2" style={{ color: '#16284F' }}>Dedicated Support</h5>
                      <p className="text-gray-600 3xl:text-lg 4xl:text-xl 5xl:text-2xl">24/7 technical support and local expertise for IT Park tenants</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 3xl:w-14 3xl:h-14 4xl:w-16 4xl:h-16 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #0C7C92, #16284F)' }}>
                      <i className="fas fa-handshake text-white text-xl 3xl:text-2xl 4xl:text-3xl"></i>
                    </div>
                    <div>
                      <h5 className="font-semibold text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl mb-2" style={{ color: '#16284F' }}>Special Rates</h5>
                      <p className="text-gray-600 3xl:text-lg 4xl:text-xl 5xl:text-2xl">Affordable pricing for Ethiopian IT Park incubatees and tenants</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  <a
                    ...
                    style={{ background: 'linear-gradient(135deg, #0C7C92, #6EC9C4)' }}
                  >
